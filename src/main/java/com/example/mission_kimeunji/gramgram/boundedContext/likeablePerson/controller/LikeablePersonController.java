package com.example.mission_kimeunji.gramgram.boundedContext.likeablePerson.controller;
...
public class LikeablePersonController {
    ...
    public String delete(@PathVariable("id") Long id) {
        RsData<LikeablePerson> rsData = likeablePersonService.delete(rq.getMember(), id);
