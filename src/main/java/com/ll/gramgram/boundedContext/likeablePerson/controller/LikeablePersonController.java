...
public class LikeablePersonController {
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping("/toList")
    public String showToList(Model model, @RequestParam(defaultValue = "") String gender, @RequestParam(defaultValue = "0") String attractiveTypeCode, @RequestParam(defaultValue = "1") String sortCode) {
        InstaMember instaMember = rq.getMember().getInstaMember();
